 ...
 *
 * IMPORTANT_NOTE This file was updated to make it smaller,
 *      as it was occupying too much of the flash memory.
 * DELETED aac & mp4a & m4a & ts_parsePacket
 * DELETED flac
 * DELETED opus
 * DELETED vorbis
 */
...
bool Audio::parseContentType(char* ct) {
    enum : int { CT_NONE, CT_MP3, CT_WAV, CT_PLS, CT_M3U, CT_ASX, CT_M3U8, CT_TXT, CT_OGG };
